    ...
    func test() throws {
        ...
        for scenario in scenarios {
            ...
            for configuration in configurations {
                ...
                print("LOGROB -----------------")
                print("LOGROB \(configuration.testName())")
                print("LOGROB ContentSize BF \(textEditor.intrinsicContentSize)")
                textEditor.invalidateIntrinsicContentSize()
                textEditor.setNeedsLayout()
                textEditor.layoutIfNeeded()
                print("LOGROB ContentSize AF \(textEditor.intrinsicContentSize)")
                print("LOGROB ------")
