...
// TODO: déplacer dans le module TextField (renomer le module en TextInput ?) ou alors mettre le VM, les Model, ... du textfield en spi public
// TODO: regarde les force cast, les naming, ...

/// Spark TextViewUIView, subclasses UITextView
public final class TextViewUIView: UITextView {
    ...
    /// The textview's custom delegate.
    ...
    /// The textview's isScrollEnabled. To grow textview according to text, set this parameter as an false.
    ...
    public var intent: TextViewIntent {
        get {
    ...
    private func setupAccessibility() {
        self.accessibilityIdentifier = TextViewAccessibilityIdentifier.view
    }
    ...
    private func setupLayout() {
        ...
        self.textContainerInset = UIEdgeInsets(
            ...
            left: self.viewModel.leftSpacing * self.scaleFactor,
            bottom: self.defaultSystemVerticalPadding,
            right: self.viewModel.rightSpacing * self.scaleFactor
        )
        ...
        self.placeHolderConstarints = [
            ...
            self.placeHolderLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: self.viewModel.leftSpacing * self.scaleFactor),
            self.placeHolderLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -self.viewModel.rightSpacing * self.scaleFactor),
...
extension TextViewUIView: UITextViewDelegate {
